...
describe('beforeOrEqual rule', () => {
  ...
  it('should return true when a date is before another date', () => {
    expect(
      beforeOrEqual.check({ value: '2013-04-29', args: ['2013-04-30'] }),
    ).toBeTruthy();
  });
  ...
  it('should return true when a date is equal to another date', () => {
    expect(
      beforeOrEqual.check({ value: '2013-04-29', args: ['2013-04-29'] }),
    ).toBeTruthy();
  });
  ...
  it('should return false when a date is after another date', () => {
    expect(
      beforeOrEqual.check({ value: '2013-04-29', args: ['2013-04-28'] }),
    ).toBeFalsy();
  });
});
